...
declare module qc {
    ...
    export class Point {
         ...
         *  两点距离
         */
        distance(point: qc.Node | {}): number;
        /**
         *  是否和另外一个坐标点重合（有x、y属性即可）
         */
        equals(point: qc.Node | {}): boolean;
        /**
         *  两点之间的夹角（true:角度，false:弧度）默认采用弧度
         */
        angle(point: qc.Node | {}, isDeg?: boolean): number;
        /**
        *  绕点(x, y)旋转toAngle度后得到的点,（true:角度，false:弧度）默认采用弧度
        */
        rotate(x: number, y: number, toAngle: number, isDeg?: boolean): Phaser.Point;
    }
    ...
    export class Node {
        ...
        /**
         * 修改可伸缩参数
         * @param {number} left - 离左边的距离
         * @param {number} right - 离右边的距离
         * @param {number} top - 离上边的距离
         * @param {number} bottom - 离下边的距离
         */
        setStretch(left: number, right: number, top: number, bottom: number): any;
         ...
         */
        setAnchor(min: Point, max: Point, keepRect?: boolean): any;
         ...
         */
        addScript(script: any): any;
        /**
         * Returns the component if the node has one attached, null if it doesn't.
         * @params script: The className of the script.
         */
        getScript(script: any): any;
        /**
         * Returns all components in the node.
         * @params script: The className of the script.
         */
        getScripts(script: any): any[];
        /**
         * 添加组件，同addScript
         * @param script 组件类或类名
         */
        addComponent(script: any): any;
        /**
         * 获取组件，同getScript
         * @param script 组件类或类名
         */
        getComponent(script: any): any;
        /**
    ...
    export class UIImage extends Node {
        ...
        constructor(game?: qc.Game, parent?: qc.Node);
        /**
         * 把图片设置为原始尺寸
         */
    ...
    export class Assets {
        ...
        load(key: string, url: string, callback?: Function, override?: boolean, isRaw?: boolean): void;
        /**
    ...
    export class Tween extends Behaviour {
        ...
        /**
         * 将动作重置到初始状态
         * @param reverse 是否是反向播放的开始，默认为false
         */
        resetToBeginning(reverse?: boolean): void;
        /**
         * 将所有组内的动作，恢复到初始状态
         * @param reverse 是否是反向播放的开始，默认为false
         */
        resetGroupToBeginning(reverse?: boolean): void;
     ...
     * Graphics，集合图形绘制
     */
    export class Graphics extends qc.Node {
        ...
        constructor(game: qc.Game, node: qc.Node);
        ...
        drawShape(shape: Circle): PIXI.GraphicsData;
        drawShape(shape: Rectangle): PIXI.GraphicsData;
        drawShape(shape: Ellipse): PIXI.GraphicsData;
        drawShape(shape: Polygon): PIXI.GraphicsData;
        endFill(): Graphics;
