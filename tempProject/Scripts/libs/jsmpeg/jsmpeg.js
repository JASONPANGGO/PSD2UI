...
JSMpeg.Source.Ajax = function () {
    ...
    AjaxSource.prototype.start = function () {
        ...
        if (window.hasBase64()) {
            this.onLoad(basedecode(window.getAssestByUrl(this.url)));
        } else {
...
JSMpeg.Source.AjaxProgressive = function () {
    ...
    AjaxProgressiveSource.prototype.start = function () {
        if (window.hasBase64()) {
            this.arrayBuffer = basedecode(window.getAssestByUrl(this.url));
            this.fileSize = parseInt(this.arrayBuffer.byteLength);
            this.loadNextChunk();
        } else {
            this.request = new XMLHttpRequest;
            this.request.onreadystatechange = function () {
    ...
    AjaxProgressiveSource.prototype.loadNextChunk = function () {
        ...
        if (window.hasBase64() && this.arrayBuffer) {
            this.onChunkLoad(this.arrayBuffer);
        } else {
            this.request = new XMLHttpRequest;
            this.request.onreadystatechange = function () {
